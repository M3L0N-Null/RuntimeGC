...
namespace RuntimeGC
{
    public class UserInterface : MainTabWindow
    {
        ...
        public override void DoWindowContents(Rect canvas)
        {
            ...
            std.Label("RuntimeGCVer".Translate("1.3"));
            std.Label("By user19990313 - Updated by Trinity");
            std.Gap();
        ...
        public void GC_wrapped(bool verbose=false)
        {
            ...
            string str = "DlgTextGC".Translate(a, PawnsAliveCount,
                                               b, PawnsDeadCount,
                                               j);
            Find.WindowStack.Add(new Dialog_MessageBox(str + "\n\n" + (i == j ? "DlgTextGCAdvice1".Translate() : "DlgTextGCAdvice2".Translate(i - j)) + (verbose ? "\n\n" + "DlgTextGCV".Translate().ToString() : ""),null,null,null,null,null,false,null,null,WindowLayer.Dialog));
